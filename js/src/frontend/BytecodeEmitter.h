...
struct MOZ_STACK_CLASS BytecodeEmitter {
 ...
 public:
  ...
  void switchToMain(bool generator = false) {
    MOZ_ASSERT(inPrologue());
    mainOffset_.emplace(bytecodeSection().code().length());

    if (!emitExecutionProgress() ||
        !emitInstrumentation(generator ? InstrumentationKind::Generator : InstrumentationKind::Main)) {
      MOZ_CRASH("switchToMain");
    }
  }
  ...
  [[nodiscard]] bool emitCall(
      ...
      bool allowRecordReplayAssert = true);
