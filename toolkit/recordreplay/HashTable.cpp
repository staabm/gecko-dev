...
// with this problem, for specific kinds of hashtables (PLDHashTables)
...
class StableHashTableInfo {
 ...
 public:
  ...
  static StaticMutex gHashInfosLock;

  inline bool IsValid() {
    StaticMutexAutoLock lock(gHashInfosLock);
...
StaticMutex StableHashTableInfo::gHashInfosLock;
